...
titleFrameUIListLayout.Parent = nil
...
local licenseCircle = Instance.new("Frame")
...
local frac = math.clamp(hours / 48, 0, 1)
local col
if frac > 0.35 then col = Color3.fromRGB(52, 199, 89)
elseif frac > 0.15 then col = Color3.fromRGB(255, 196, 60)
else col = Color3.fromRGB(255, 80, 95) end
licenseCircle.BackgroundColor3 = col
licenseText.TextColor3 = col
local s = math.floor(4 + frac * 9 + 0.5)
...
prompt.BackgroundColor3 = Y2kTheme.Background
...
themeSec:Header({ Name = "Y2k Customization" })
themeSec:Divider({ Text = "Theme" })
themeSec:Colorpicker({
Name = "Accent Color",
Default = MacLib.Theme.Accent,
Callback = function(color) MacLib:SetThemeColor("Accent", color) end,
}, "Y2kAccent")
themeSec:Colorpicker({
Name = "Background Color",
Default = MacLib.Theme.Background,
Callback = function(color) MacLib:SetThemeColor("Background", color) end,
}, "Y2kBackground")
themeSec:Colorpicker({
Name = "Text Color",
Default = MacLib.Theme.Text,
Callback = function(color) MacLib:SetThemeColor("Text", color) end,
}, "Y2kText")
themeSec:Divider({ Text = "Window" })
themeSec:Toggle({
Name = "Lock Window (no drag)",
Default = false,
Callback = function(state) Window:SetLocked(state) end,
}, "Y2kLockWindow")
sections.MainSection2:Header({ Name = "Right Side" })
sections.MainSection2:Toggle({ Name = "Right Toggle", Default = true })
...
warn("=== Y2k DONE: ok=" .. tostring(_y2kOk) .. " ===")
return MacLib
